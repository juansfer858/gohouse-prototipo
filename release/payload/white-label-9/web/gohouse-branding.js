...
(() => {
  ...
  if (pageKind() === 'panel' && !document.getElementById('white-label-qr-script')) {
    const qrExtra = document.createElement('script');
    qrExtra.id = 'white-label-qr-script';
    qrExtra.src = '/gohouse-qr.js';
    qrExtra.defer = true;
    document.head.appendChild(qrExtra);
  }
