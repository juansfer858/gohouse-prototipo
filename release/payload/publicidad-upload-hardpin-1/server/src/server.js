...
app.post('/api/upload-data-url', authMiddleware(), async (req,res,next) => {
  try {
    ...
    // La ubicación física de archivos no depende de la marca comercial ni de
    // variables heredadas. El autodeploy mantiene /opt/gohouse/web como raíz web.
    const uploadDir = PUBLIC_UPLOAD_DIR;
